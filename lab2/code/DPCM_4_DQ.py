...
encoded_data = my_dpcm.encoder(wave_data, 4)
my_dpcm.write_encoded_data('../results/1_4bit_dq.dpc', encoded_data)
# 解码步骤
encoded_data = my_dpcm.read_encoded_data('../results/1_4bit_dq.dpc')
decoded_data = my_dpcm.decoder(encoded_data)
my_dpcm.write_decoded_data('../results/1_4bit_dq.pcm', decoded_data)
from SNR import *
snr = SNR(wave_data, decoded_data)
print('4比特直接量化得到的信噪比是: ', snr, '分贝')